...
function HeroHeading() {
  return (
    <section className="space-y-12 xl:w-full">
      <h1 className="mx-auto text-5xl font-light text-center lg:px-0 lg:text-6xl md:text-5xlplus md:max-w-2xl md:px-4">
        We&apos;re glad you ended up here
      </h1>
      <figure className="flex items-center justify-around gap-4 sm:gap-0 md:px-16 lg:px-32">
        <img src="/image/contact-us/social.png" alt="social icons" className="size-24 sm:size-32 lg:size-40" />
        <figcaption className="flex flex-col items-center sm:gap-2">
