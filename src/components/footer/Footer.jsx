...
function Footer() {
  ...
  return (
    <>
      {inView && (
        <div className={`fixed top-0 z-50 w-full bg-beige aria-hidden`}>
          <Nav />
        </div>
      )}
      <footer
        ref={ref}
        className="sticky bg-black text-offWhite rounded-t-[2rem] pb-[2rem] lg:rounded-t-[3rem] lg:pb-[3rem] 2xl:rounded-t-[4rem] 2xl:pb-[4rem] 2xl:-mt-[4rem] -mt-[2rem] lg:-mt-[3rem]"
      >
        <Container>
